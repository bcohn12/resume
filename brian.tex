...
\fancyhead{
  ...
  \begin{tabularx}{17cm}{X r}
    ...
    \href{https://github.com/briancohn}{GitHub.com/briancohn} & \href{mailto:briancohn@kaspect.com}{briancohn@kaspect.com}
  \end{tabularx}
}
\fancyfoot[C]{\thepage}
...
\vspace*{-15mm}\section*{Skills}
  ...
  \vspace*{1mm}\begin{tabularx}{17cm}{X}
    "Feasibility Theory reconciles alternative approaches to neuromuscular control"\\
