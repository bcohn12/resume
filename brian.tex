...
\vspace*{3mm}\section*{Summary}
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    \$5,000 AWS Prize, USC Venture Incubation Program (Virtual Reality) & Oct-2015\\
    \$5,000 AWS Prize, USC Venture Incubation Program (Biomedical Compute Clouds) & Oct-2015\\
  ...
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    ...
    Poster presentation, Winter Workshop on Neuromechanics, New Orleans & Jan-2016 \\
