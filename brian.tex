...
\fancyhead{
  ...
  \begin{tabularx}{17cm}{X r}
    ...
    \href{https://github.com/bcohn12}{GitHub.com/bcohn12} & \href{mailto:briancohn@kaspect.com}{briancohn@kaspect.com}
  \end{tabularx}
}
\fancyfoot[C]{\thepage}
...
\vspace*{-15mm}\section*{Skills}
  \noindent\begin{tabularx}{17cm}{l X}
    \textbf{Operating Systems} & Linux (Red Hat Enterprise, Ubuntu), FreeBSD, MacOS, Windows \\
    \textbf{Programming Languages} & Scala, Python, R, Matlab, Bash, Yaml, Ruby \\
    \textbf{Databases} & S3, MongoDB, RedShift, MySQL, PostgreSQL \\
    \textbf{Development Tools} & Maven, Scala Build Tool, IntelliJ, Vim, Eclipse, iPython, Jupyter Notebook, RStudio \\
    \textbf{Distributed Technologies} & Apache Spark, Spark-Streaming, Spark SQL \\
    \textbf{Server Technologies} & Jenkins, Travis-CI, Bash \\
...
\vspace*{3mm}\section*{Summary}
  \noindent\begin{minipage}{17cm}
    \noindent\begin{itemize}[leftmargin=6mm,topsep=0mm,itemsep=-1mm]
      \item Experience in every stage of the Software Development Life Cycle including planning, storyboarding, engineering, programming, user-testing, and documentation.
      \item Ability to lead large in-person and remote teams and effectively recruit new talent. 
      \item Mastery of project management, leveraging tools such as Github, Bitbucket, Git, JIRA, SBT, Maven, and Jenkins.
      \item Able to communicate complex ideas to diverse audiences in clear and concise language, and give conference talks on behalf of corporate clients.
    \end{itemize}
  \end{minipage}
  ...
  \vspace*{0mm}\noindent\begin{tabularx}{17cm}{X r}
    ...
    \textit{Ph.D. Computer Science, Viterbi Dean's Doctoral Fellowship} & \textbf{}
  \end{tabularx} 

  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    \textbf{Pitzer College} & \textit{2014} \\
    \textit{B.A. with Honors - Computational Biology} & \textbf{}
  \end{tabularx}

  \vspace*{2mm}\section*{Selected Awards}
  
  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    \$5,000 AWS Prize, USC Venture Incubation Program (Virtual Reality) & 10-2015\\
    \$5,000 AWS Prize, USC Venture Incubation Program (Biomedical Compute Clouds) & 10-2015\\
    \$10,000 Grand Prize (USC Hacking Virtual Medicine) IEEE Standards Association  & 10-2015\\
    USC Health Technology Innovation Fellowship & 8-2015\\ 
    USC Viterbi Dean's Doctoral Fellowship  & 5-2015 \\
    Pitzer College Student Research Award & 11-2013 \\
    Pitzer College Student Research Award & 3-2013 \\
    Howard Hughes Medical Institute Research Grant & 3-2013
  \end{tabularx}

  \vspace*{2mm}\section*{Invited Talks}

  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
    37th Annual International IEEE Engineering in Medicine and Biology Society, Milan Italy & 8-2015 \\
    USC Viterbi School of Computer Science Seminar Series & 8-2015 \\
    39th Annual Conference of the American Society of Biomechanics & 8-2015 \\
    25th Annual Conference of the Society for the Neural Control of Movement & 4-2015 \\
    Masters Capstone Research Symposium, Keck Graduate Institute & 5-2014 \\
    Masters Project Thesis Defense, Keck Graduate Institute & 4-2014 \\
    Public Masters Capstone Talk, Keck Graduate Institute & 12-2013 \\
    Invited speaker, UC Davis FishLab & 10-2013 \\
    Regional Society for Integrative and Comparative Biology, UC Riverside & 10-2013 \\
    Science Department Symposium, Keck Graduate Institute & 10-2013 \\
    Mathematical Bioscience Institute, Ohio State University & 7-2013\\
    Howard Hughes Medical Institute Student Seminar & 3-2013
  \end{tabularx}

  \vspace*{2mm}\section*{Conferences and Teaching}

  \vspace*{1mm}\noindent\begin{tabularx}{17cm}{X r}
   Guest Lecture for Biomedical Engineering 504 & \multirow{4}{*}{}{10-2015} \\
    USC Viterbi School of Biomedical Engineering \\
    "Tools for the visualization of tendon driven systems" \\[2mm]

Guest Lecture for Neuromuscular Systems & \multirow{4}{*}{}{10-2014} \\
    USC Division of Biokinesiology and Physical Therapy \\
    "Neuromechanic optimization in open source software" \\
    https://github.com/bcohn12/biokinesiology \\[2mm] 

    PharmaPack North America Conference & \multirow{3}{*}{}{6-2014} \\
    ...
    Eli Lilly and Company Headquarters & \multirow{2}{*}{}{5-2014} \\
    "Big Data Analytics in Post-Market Surveillance and Pharmacological Vigilance" \\[2mm]

    Guest Lecture for Sensory Evolution & \multirow{3}{*}{}{4-2014} \\
    ...
    National Society for Integrative and Comparative Biology & \multirow{3}{*}{}{1-2014} \\
