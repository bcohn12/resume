...
\begin{document}
  ...
  %    \item More than a decade of full time software development experience using languages like Python, Bash, YAML, HTML, PHP, CSS, and JavaScript.
  %    \item Fluent in Ansible for automation of deployment and configuration of a wide variety of services. 
  %    \item Familiar with installation, configuration, and use of relational databases such as MySQL and PostgreSQL as well as non-relational databases such as MongoDB.
  %    \item Management of SCM and other tools, such as github, Bitbucket, git, SVN, CVS, JIRA, Sonar, SBT, Maven, and Jenkins.
